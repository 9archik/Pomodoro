	...
	return (
		<div className={styles.root}>
			<div className={styles.header}>
				<h3>
					Tasks <span className="timer-task__num-task">{storage ? storage.length : 0}</span>
				</h3>
			...
			<ul className={styles.taskList}>
				{storage &&
					storage.map((element, index) => {
						return (
							<li key={index}>
								<div className={!element.isEdit ? styles.taskItem : styles.isEdit}>
									<input onClick={!element.checked} type="checkbox" id={index} />
									<label onClick={!element.checked} for={index}>
										{element.info}
									</label>
								...
								<div className={element.isEdit ? styles.taskItemInput : styles.isEdit}>
									...
									<div>
										...
										<button onClick={() => onCancelClick(index)}>Cancel</button>
									</div>
								</div>
							</li>
						);
